...
import io.khusanjon.onlineclassroom.security.DomainUserDetailsService;
import io.khusanjon.onlineclassroom.security.JwtAuthenticationEntryPoint;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
//                .antMatchers("/api/auth/login", "/api/messages/failed-messages/export/excel/{transactionId}").permitAll()
                .antMatchers(AUTH_WHITELIST).permitAll()
//                .antMatchers("/api/staff-chair/**")
                .anyRequest()
                .authenticated();
